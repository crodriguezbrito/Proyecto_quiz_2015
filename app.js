...
var partials = require('express-partials'); //instalamos middleware en app.js ***
...
app.use(partials()); //** usamos el paquete express-partials
...
//Middleware Helpers dinamicos:
app.use(function(req, res, next) {
    //guardar en path en session.redir para despues de login
...
if (app.get('env') === 'development') {
    app.use(function(err, req, res, next) {
        ...
        res.render('error', {
            message: err.message,
            error: err,
            errors: [] //errores en la validacion
        });
    });
}
